...
public class ComandoPrompt 
{
    ...
    /**
     * M�todo acessor get para o nome do comando.
     * 
    ...
    /**
     * M�todo acessor get para os argumentos que seguram ao nome do comando.
     * 
     * @return Lista de argumentos do comando, protegida contra modifica��es externas.
     */
